				...
				<section className="section">
					<div className="container">
						<div className="row">
							...
							<p className="text">
								COVID-19 SOS a unique portfolio of services that keep
								healthcare professionals which fulfilling Emergency
								Needs of COVID Patients.The Mission of COVID-19 SOS is
								to Improve the Health of Community and the World by
								setting the standard of Excellence in Our Service. In
								this Emerging Pandemic Situation COVID-19 Our Team
								Provide Help to Covid patients. We fulfill the
								requirements of Medicine and Provide Faster service to
								COVID Positive Patients in the Pandemic situation of
								COVID-19. We Provide Oxygen Cylinder , Plasma,
								Remdesivir Injection and Medicines. We Organize
								Vaccination Camp for the HealthCare of People.Thousand
								of COVID Patients are Recovered by Our Services.We are
								Awarded By 3 National Government Organizations.
							</p>
							<div className="col-md-12 text-center">
					...
					<div className="container">
						<div className="row">
							...
							<div className="col-md-4 text-center">
								...
								<p className="text1">
									To help Patients meet the needs of individual and
									Families through cordinate Effective Prevention
									Services
								</p>
							</div>
							<div className="col-md-4 text-center">
								...
								<p className="text1">
									To Promote the Healthy Development for Individual
									Families through Research and Fight Against Covid-19
								</p>
							</div>
							<div className="col-md-4 text-center">
								<h6 class="a ">Our Core Values</h6>
								<p className="text1">
									Inclusive Healthy and Safetiness Environment,
									Integrity, Honesty, Respect, People Oriented and
									Ethically Interaction{" "}
								</p>
							</div>
						</div>
					</div>
